...
DEEPFACE_API_URL = os.environ.get("DEEPFACE_API_URL", "http://deepface:5005")
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                flash(f"Error communicating with DeepFace API: {response.status_code}", "error")
        ...
        if response.status_code == 200:
            ...
            if result.get("success") and result.get("verified"):
                ...
                if user:
                    ...
                    return jsonify({
                        "success": True, 
                        "redirect": url_for("signin_success", user_id=str(user["_id"]))
                    })
                else:
                    return jsonify({
                        "success": False, 
